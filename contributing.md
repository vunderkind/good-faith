...
> This guide was heavily adapted from the [PowerToys Contributor Guide](https://github.com/microsoft/PowerToys/blob/master/contributing.md)
...
* Have a question that you need answers to? File an issue
...
* What device you're running (eg. iPhone, Android, Desktop)
...
Once the team have approved an issue, development can proceed. If no developers are immediately available, issues will be labeled "Help Wanted". To find a list of development opportunities waiting for developer involvement, visit the Issues and filter on [the Help-Wanted label](https://github.com/vunderkind/good-faith/labels/help%20wanted).
