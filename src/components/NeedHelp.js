...
const NeedHelp = () => {
    return (
        <div className="App" id="hp">
            ...
            <p>It may take a little while for us to add your name to the list, as we'll first have to call you and verify your identity. Thank you for your patience!</p>
